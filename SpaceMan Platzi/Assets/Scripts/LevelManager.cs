...
public class LevelManager : MonoBehaviour
{
    ...
    public void AddLevelBlock()
    {
        ...
        if (currentLevelBlock.Count == 0) //todaviamos no añadimos ningun bloque
        {
        ...
        block.transform.SetParent(this.transform,false); //Todos los bloques quedaran como hijos del LevelManager
